 ...
 * @category Cube building
 */
export declare function pivot<TElement>(array: readonly TElement[], first: Dimension<TElement>): Matrix<TElement>;
/**
 ...
 * @category Cube building
 */
export declare function pivot<TElement>(array: readonly TElement[], first: Dimension<TElement>, second: Dimension<TElement>): Cube<TElement>;
/**
 ...
 * @category Cube building
 */
export declare function pivot<TElement>(array: readonly TElement[], first: Dimension<TElement>, ...others: Dimension<TElement>[]): Hypercube<TElement>;
/**
