 ...
 */
export declare function dimension<DValue, TValue>(source: Array<DValue>, generator: Function<DValue, Criteria<TValue>>): Dimension<TValue>;
/**
 ...
 */
export declare function property<TValue>(key: keyof TValue): Function<TValue[keyof TValue], Criteria<TValue>>;
/**
