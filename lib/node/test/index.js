...
const nationality = Object.values(Nationality).map((0, __1.criteria)('nationality'));
const gender = data.map(person => person.gender).filter(distinct_1.distinct).sort().map((0, __1.criteria)('gender'));
