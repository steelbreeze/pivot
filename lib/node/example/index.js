...
const x = pivot_1.axis.fromTable(fulham_1.squad, 'position');
const y = pivot_1.axis.fromTable(fulham_1.squad, 'country', player => player.country.substr(0, 3).toUpperCase());
