...
const axes = {
    x: pivot.join(pivot.deriveDimension(fulham_1.squad, 'position'), pivot.deriveDimension(fulham_1.squad, 'position')),
    y: pivot.deriveDimension(fulham_1.squad, 'country')
};
