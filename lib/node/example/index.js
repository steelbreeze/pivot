...
const x = positions.map((0, __1.property)('position')); // using the built-in property map generator
const y = countries.map((country) => (player) => player.country === country); // using a user-defined generator
