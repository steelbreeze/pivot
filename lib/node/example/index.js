...
const x = pivot.columnAxis(fulham_1.squad, 'position');
const y = pivot.columnAxis(fulham_1.squad, 'short country', { get: player => player.country.substr(0, 3).toUpperCase() });
