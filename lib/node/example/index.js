...
const p = __importStar(require("../pivot"));
...
const position = p.dimension(fulham_1.squad, 'position');
const country = p.dimension(fulham_1.squad, 'country', player => player.nationality);
...
// create a pivot cube
const cube = p.pivot(fulham_1.squad, x, y);
