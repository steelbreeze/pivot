 ...
 * @category Cube query
 */
const query = (matrix, selector) => map(matrix, slice => map(slice, selector));
exports.query = query;
/**
 ...
 * @category Cube query
 */
const sum = (selector) => slice => reduce(slice, (accumulator, element) => accumulator + selector(element), 0);
exports.sum = sum;
/**
 ...
 * @category Cube query
 */
const average = (selector) => slice => (0, exports.sum)(selector)(slice) / slice.length;
exports.average = average;
// slices the data by one dimension
function slicer(elements, dimension) {
