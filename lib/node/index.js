...
exports.count = exports.average = exports.sum = exports.select = exports.map = exports.filter = exports.cube = exports.expand = exports.dimension = exports.distinct = void 0;
/**
 ...
 */
const dimension = (values, key, getValue = row => row[key], getCriteria = value => [{ key, value, predicate: row => getValue(row) === value }]) => values.map(getCriteria);
 ...
 */
const expand = (getCriterion) => criteria => [getCriterion(criteria), ...criteria];
