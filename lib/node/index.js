...
const pivotImplementation = (source, first, second, ...others) => first.map(predicate => second ? pivotImplementation(source.filter(predicate), second, ...others) : source.filter(predicate));
/**
 ...
 */
exports.pivot = pivotImplementation;
/**
