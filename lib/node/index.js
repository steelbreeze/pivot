...
const pivotImplementation = (source, first, second, ...others) => first.map(predicate => second ? pivotImplementation(slice(source, predicate), second, ...others) : slice(source, predicate));
