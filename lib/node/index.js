 ...
 */
const dimension = (values, key, getCriteria = value => [{ key, value, predicate: row => row[key] === value }]) => {
    let result = new Array(values.length), i = values.length;
    while (i--) {
