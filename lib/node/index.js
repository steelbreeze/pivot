...
exports.count = exports.average = exports.sum = exports.select = exports.filter = exports.map = exports.slice = exports.cube = exports.dimension = exports.distinct = exports.unique = void 0;
/**
 ...
 */
const distinct = (table, key, getValue = row => row[key]) => table.map(getValue).filter(exports.unique);
 ...
 */
const cube = (table, axes) => exports.slice(axes.y)(table).map(exports.slice(axes.x));
exports.cube = cube;
/**
 ...
 * @returns Returns a function that will take a table and slice it into an array of tables each conforming to the criteria of a point on a dimension.
  */
const slice = (dimension) => values => dimension.map(criteria => values.filter(value => criteria.every(criterion => criterion.predicate(value))));
exports.slice = slice;
/**
