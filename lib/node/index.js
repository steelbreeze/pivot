...
exports.average = exports.sum = exports.select = exports.filter = exports.map = exports.slice = exports.cube = exports.dimension = void 0;
/**
...
const slice = (dimension) => (source) => dimension.map((criteria) => {
    ...
    let length = 0, result = source.filter((row) => criteria(row) || !(source[length++] = row));
