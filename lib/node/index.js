...
exports.average = exports.count = exports.sum = exports.query = exports.pivot = exports.property = exports.dimension = void 0;
/**
...
exports.sum = sum;
const count = (source) => source.length;
exports.count = count;
/**
 ...
 * @category Cube query
 */
const average = (selector) => (source) => (0, exports.sum)(selector)(source) / (0, exports.count)(source);
