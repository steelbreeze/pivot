 ...
 */
const slice = (source, dimension) => dimension.map((predicate) => source.filter(predicate));
exports.slice = slice;
/**
 ...
 * @category Cube building
 */
const pivot = (source, first, ...[second, ...others]) => second ? (0, exports.slice)(source, first).map((matrix) => (0, exports.pivot)(matrix, second, ...others)) : (0, exports.slice)(source, first);
exports.pivot = pivot;
/**
