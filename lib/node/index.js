...
exports.count = exports.average = exports.sum = exports.select = exports.map = exports.filter = exports.slice = exports.cube = exports.dimension = exports.distinct = void 0;
/**
 ...
 */
const filter = (cube, predicate) => 
//	cube.map(row => row.map(cell => cell.filter(predicate)));
exports.map(cube, cell => cell.filter(predicate));
