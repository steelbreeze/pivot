...
const pivotImplementation = (source, first, second, ...others) => first.map(predicate => second ? pivotImplementation(split(source, predicate), second, ...others) : split(source, predicate));
