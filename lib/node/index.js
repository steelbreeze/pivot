 ...
 */
const slice = (source, dimension) => dimension.map((predicate) => filter(source, predicate));
exports.slice = slice;
/**
 ...
 * @category Cube building
 */
const pivot = (source, first, ...[second, ...others]) => second ? (0, exports.slice)(source, first).map((sliced) => (0, exports.pivot)(sliced, second, ...others)) : (0, exports.slice)(source, first);
exports.pivot = pivot;
/**
 ...
 * @category Cube query
 */
const query = (matrix, selector) => matrix.map((sliced) => sliced.map(selector));
exports.query = query;
/**
