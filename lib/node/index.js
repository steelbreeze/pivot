...
const sliceAndDice = (source, first, second, ...others) => second ? first.map(predicate => sliceAndDice(slice(source, predicate), second, ...others)) : first.map(predicate => slice(source, predicate));
/**
 ...
 */
const pivot = (source, first, second, ...others) => sliceAndDice([...source], first, second, ...others);
exports.pivot = pivot;
/**
