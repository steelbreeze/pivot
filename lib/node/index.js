...
exports.average = exports.sum = exports.count = exports.select = exports.map = exports.filter = exports.cube = exports.slice = exports.axis = void 0;
...
class axis {
     ...
     */
    static fromTable(table, key, selector = (row) => row[key], sorter) {
     ...
     */
    static fromValues(values, key, selector = (row) => row[key]) {
