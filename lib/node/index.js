 ...
 */
const cube = (records, dimension, ...dimensions) => dimension.map(criteria => dimensions.length ? (0, exports.cube)(records.filter(criteria), dimensions[0], ...dimensions.slice(1)) : records.filter(criteria));
exports.cube = cube;
/**
