...
exports.average = exports.sum = exports.select = exports.map = exports.cube = exports.criteria = void 0;
/**
 ...
 */
const cube = (records, y, x) => y.map(Array.prototype.filter, records).map(matrix => x.map(Array.prototype.filter, matrix));
exports.cube = cube;
/**
