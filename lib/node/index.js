...
function partition(source, dimension) {
...
const dice = (source, first, second, ...others) => second ? partition(source, first).map((slice) => dice(slice, second, ...others)) : partition(source, first);
/**
