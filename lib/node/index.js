 ...
 */
const pivot = (source, [first, ...remaining]) => first ? first.map(predicate => remaining.length ? (0, exports.pivot)(source.filter(predicate), remaining) : source.filter(predicate)) : source;
exports.pivot = pivot;
/**
