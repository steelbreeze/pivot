...
A minimalist pivot table library for TypeScript/JavaScript. While small in size (a mere 892 bytes when minified), this library is large in capability, supporting derived and custom dimensions, derived fields for dimensions and calculations, multiple dimensions for an axis. Even hypercubes are possible.
