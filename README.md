...
A minimalist pivot table library for TypeScript/JavaScript. While small (just 685 bytes when minified), this library is large in capability, supporting derived and custom dimensions, derived fields for dimensions and calculations, composite dimensions, filtering.
