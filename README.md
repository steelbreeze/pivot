...
A minimalist pivot table library for TypeScript/JavaScript. While small in size (a mere 971 bytes when minified), this library is large in capability, supporting derived or custom dimensions, derived fields for dimensions and calculations, multiple dimensions for an axis; even hypercubes can be generated.
