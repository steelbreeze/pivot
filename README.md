...
A minimalist pivot table library for TypeScript/JavaScript. While small in size (a mere 999 bytes when minified), this library is large in capability, supporting user-supplied or source data derived dimensions, derived fields for dimensions and calculations, multiple dimensions for an axis; even hypercubes can be generated.
