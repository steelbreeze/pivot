# pivot
A minimalist pivot table library for TypeScript/JavaScript. While small in size (a mere 875 bytes when minified), this library is large in capability, supporting user-supplied or source data derived dimensions, derived fields for dimensions and calculations, multiple dimensions for an axis; even hypercubes can be generated.
...
## Example
The following is the result of pivoting the information about the Fulham Football Club mens squad in the form of an array of objects.
